...
public class StringRun {
	...
	public static void main(String[] args) {
		...
		//new String으로 변수를 설정하면 객체 주소메모리값을 새로 할당함
		String str3 = "abc";
		String str4 = "abc";
		...
		//System.out.println(System.identityHashCode(a.equals(d)));
		System.out.println(a.equals(c));
		System.out.println(a.equals(d));
		
		//indexOf() 해당 문자열의 시작 인덱스(문자가 없으면 -1 출력)
		System.out.printf("%n");
		//          0123456789
		String e = "Hello Java!!";
		System.out.println(e.indexOf("Jav"));
		System.out.println(e.indexOf("Jab"));
		System.out.println(e.lastIndexOf("!"));
		
		//contains() 해당 문자열의 포함여부
		System.out.printf("%n");
		System.out.println(e.contains("va"));
		System.out.println(e.contains("Jab"));
		
		//charAt() 특정 위치의 문자 반환
		System.out.printf("%n");
		System.out.println(e.charAt(9));
		
		//replaceAll() 특정 문자열을 교체한 문자열 반환
		System.out.println(e.replaceAll("Java","HTML"));
		String f = e.replaceAll("Java", "HTML");
		System.out.println(f);
		
		//substring() 문자열의 특정부분 추출
		System.out.printf("%n");
		...
		//문자열을 비교하여 같다면 0 작으면 음수 크면 양수 반환 IgnoreCase는 대문자 상관 x
		System.out.printf("%n");
		...
		//split("x")x 안에 있는 값을 기준으로 문자열을 배열로 나누어 출력함
		//토할거같다
		System.out.printf("%n");
		String test = "이 문장의 문자열-입니다./This is the String.";
		...
		token = test.split("-");
		System.out.println(Arrays.toString(token));
		//System.out.println(token[0]); 해당 문자열 출력
